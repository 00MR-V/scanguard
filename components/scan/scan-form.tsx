  ...
  if (mode === "CAMERA") {
    return (
      <section className="flex flex-1 flex-col gap-5">
        <div className="flex min-h-[56vh] flex-col overflow-hidden rounded-lg border border-zinc-200 bg-zinc-950 shadow-sm">
          ...
          <div className="relative flex flex-1 items-center justify-center bg-black">
            <video
              ref={videoRef}
              className="h-full min-h-[51vh] w-full object-cover"
              muted
              playsInline
            />
